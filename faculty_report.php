...
<header>
    ...
    <nav>
        <ul>
            <li><a href="faculty_office.php">Home</a></li>
            <li><a href="faculty_add.php">Add Item</a></li>
            <li><a href="faculty_report.php" class="active">Print</a></li>
            <li><a href="faculty_barcode.php">Barcode</a></li>
            <li><a href="faculty_qr.php">QR Code</a></li>
...
<div class="search-container">
    <form method="POST" class="filter-form">
        <select name="filter_field" required>
            ...
            <option value="Item/Commodity Description" <?php if ($filter_field == 'Item/Commodity Description') echo 'selected'; ?>>Item / Commodity</option>
        ...
        <a href="faculty_report.php">Reset</a>
    </form>
</div>
