...
<header>
    ...
    <nav>
        <ul>
            <li><a href="faculty_office.php" class="active">Home</a></li>
            <li><a href="faculty_add.php">Add Item</a></li>
            <li><a href="faculty_report.php">Print</a></li>
            <li><a href="faculty_barcode.php">Barcode</a></li>
            <li><a href="faculty_qr.php">QRcode</a></li>
            <li class="nav-right">
...
<div class="search-container">
    ...
    <form method="POST" class="filter-form">
        <select name="filter_field" required>
            ...
            <option value="Item/Commodity Description" <?php if($filter_field=='Item/Commodity Description') echo 'selected'; ?>>Item/Commodity Description</option>
        ...
        <a href="faculty_office.php">Reset</a>
    </form>
</div>
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    /*echo "<td>
        <div class='action-buttons'>
            <a class='btn-edit' href='faculty_edit.php?dsr=" . urlencode($row['DSR No']) . "'>Update</a>
