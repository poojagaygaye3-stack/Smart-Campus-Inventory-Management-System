...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="admin_barcode.php" class="active">Barcode</a></li>
...
<div class="search-container">
    <form method="GET" action="">
        ...
        <input type="text" name="item_desc" placeholder="Search by Item Name" value="<?php echo htmlspecialchars($item_search); ?>">
        <button type="submit">Search</button>
        <a href="admin_barcode.php">Reset</a>
    </form>
</div>
